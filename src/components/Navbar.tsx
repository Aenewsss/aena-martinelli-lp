        ...
        <div className={`container d-flex flex-column navbar align-center ${isScrolled && "nav-scroll"}`}>
            <div className="d-flex justify-between w-100 gap-2">
                ...
                <div className="d-flex gap-1 justify-center">
                    <a target="_blank" href="https://api.whatsapp.com/send?phone=5561992634979&text=Olá, Aenã. Eu gostaria de saber mais sobre os seus serviços referentes a criação de sites e aplicativos!" className="text-green fs-24 nav-link nav-important">Quero saber mais!</a>
